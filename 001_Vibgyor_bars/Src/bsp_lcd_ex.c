...
#include "bsp_lcd.h"
	...
	#define FB_SIZE (BSP_FB_HEIGHT * BSP_FB_WIDTH * 1)
#elif BSP_LCD_PIXEL_FMT == BSP_LCD_PIXEL_FMT_RGB565
	#define FB_SIZE (BSP_FB_HEIGHT * BSP_FB_WIDTH * 2)
#elif BSP_LCD_PIXEL_FMT == BSP_LCD_PIXEL_FMT_RGB666
	#define FB_SIZE ((BSP_FB_HEIGHT * BSP_FB_WIDTH * 2) + 19200UL)
#elif BSP_LCD_PIXEL_FMT == BSP_LCD_PIXEL_FMT_RGB888
	#define FB_SIZE (BSP_FB_HEIGHT * BSP_FB_WIDTH * 3)
#else
